    ...
    (function (Controllers) {
        ...
        var MapController = (function () {
            function MapController($scope, toaster, $analytics, $location, $stateParams, leafletBoundsHelper, leafletData, search, region, studyArea, StatisticsGroup, exploration, eventService) {
                ...
                //subscribe to Events
                this.eventService.SubscribeToEvent(StreamStats.Services.onSelectedStudyAreaChanged, new WiM.Event.EventHandler(function () {
            ...
            MapController.prototype.onSelectedStudyAreaChanged = function () {
                ...
                this.studyArea.selectedStudyArea.Features.forEach(function (layer) {
                    ...
                    _this.eventService.RaiseEvent(WiM.Directives.onLayerAdded, _this, new WiM.Directives.LegendLayerAddedEventArgs(item.name, "geojson", _this.geojson[item.name].style));
                });
