...
module StreamStats.Controllers {
    ...
    implements INavbarController
  {
    ...
    constructor(
      $scope: INavbarControllerScope,
      $http: ng.IHttpService,
      modal: Services.IModalService,
      studyArea: Services.IStudyAreaService
    ) {
    ...
    public checkURLParams() {
      ...
      if (BP) {
        ...
        if (BP == "streamGrid") {
          // open streamgrids batch processor page
          this.modalService.openModal(Services.SSModalType.e_batchprocessor, {
            tabName: "streamGrid",
          });
        }
        if (BP == "manageQueue") {
          // open queue batch processor page
          this.modalService.openModal(Services.SSModalType.e_batchprocessor, {
            tabName: "manageQueue",
          });
        }
