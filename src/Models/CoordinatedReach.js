...
(function (StreamStats) {
    ...
    (function (Models) {
        ...
        ;
        AddFlowCoefficient(code, string, aCoeff, number, bCoeff, number);
        void Execute(parameters, Array(), Services.IRegressionRegion);
    ...
    CoordinatedReach.prototype.getValue = function (item, drnArea) {
        try {
            if (!item.CoefficientA || !item.CoefficientB || !drnArea)
                return null;
            return item.CoefficientA * drnArea *  * item.CoefficientB;
        }
        catch (e) {
            return null;
        }
...
exports.CoordinatedReach = CoordinatedReach;
