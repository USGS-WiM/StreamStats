...
(function (WiM) {
    ...
    (function (Directives) {
        'use strict';
        var WateruseBarChart = (function () {
            function WateruseBarChart() {
            ...
            WateruseBarChart.instance = function () {
                return new WateruseBarChart;
            };
            WateruseBarChart.prototype.link = function (scope, element) {
                ...
                var margin = { top: 20, right: 20, bottom: 30, left: 40 }, width = 480 - margin.left - margin.right, height = 360 - margin.top - margin.bottom;
