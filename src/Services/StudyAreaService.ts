...
module StreamStats.Services {
    ...
    class StudyAreaService extends WiM.Services.HTTPServiceBase implements IStudyAreaService {
        ...
        // private _wateruseQ10 = 0;
        // public set wateruseQ10(val: any) {
        //     if (this._wateruseQ10 != val) {
        //         this._wateruseQ10 = val;
        //     }
        // }
        // public get wateruseQ10(): any {
        //     return this._wateruseQ10        
        // }
        ...
        public computeRegressionEquation(regtype: string) {
            this.nssService.onSelectedStatisticsGroupChanged.subscribe(new WiM.Event.EventHandler<NSSEventArgs>((sender: any, e: NSSEventArgs) => {
                this.eventManager.SubscribeToEvent(onSelectedStudyParametersLoaded, new WiM.Event.EventHandler<NSSEventArgs>((sender: any, e: NSSEventArgs) => {
                    this.nssService.estimateFlows(this.studyAreaParameterList,"value", this.selectedStudyArea.RegionID);
                    console.log(this.nssService.selectedStatisticsGroupList);
                    this.selectedStudyArea.wateruseQ10 = this.nssService.selectedStatisticsGroupList[0].regressionRegions[0].results[9].value;
                }));
                this.loadParameters();
            }));
