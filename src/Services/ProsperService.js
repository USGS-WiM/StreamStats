    ...
    (function (Services) {
        ...
        var ProsperService = (function (_super) {
            ...
            ProsperService.prototype.loadAvailablePredictions = function () {
                var _this = this;
                try {
                    this.toaster.pop('wait', "Loading Available Prosper Predictions", "Please wait...", 1000);
                    ...
                    this.Execute(request).then(function (response) {
                        ...
                        _this.toaster.clear();
                        _this.toaster.pop('error', "There was an error requesting available prosper predictions.", "Please retry", 10000);
                    });
                }
                catch (e) {
